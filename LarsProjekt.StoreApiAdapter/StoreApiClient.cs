...
{
    private readonly StoreApiUserOptions _userOptions;
    private readonly StoreApiUrlOptions _urlOptions;
    public StoreApiClient(IOptions<StoreApiUserOptions> userOptions, IOptions<StoreApiUrlOptions> urlOptions)
    {
