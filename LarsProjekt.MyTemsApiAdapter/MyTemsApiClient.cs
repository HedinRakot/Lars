...
public class MyTemsApiClient : IMyTemsApiClient
{
    //private readonly ApiUserOptions _userOptions;
    private readonly MyTemsApiUrlOptions _urlOptions;
    public MyTemsApiClient(
        //IOptions<ApiUserOptions> userOptions, 
        IOptions<MyTemsApiUrlOptions> urlOptions)
    {
